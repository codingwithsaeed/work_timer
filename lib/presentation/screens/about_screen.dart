...
class AboutScreen extends StatelessWidget {
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  WidgetSpan(
                      child:
                          Icon(Iconsax.heart5, color: context.errorColor).marginSymmetric(horizontal: Dimens.sPadding),
  ...
  void _launchTelegram() async {
    try {
      final uri = Uri.parse(Platform.isAndroid ? 'tg://resolve?domain=saeed1814' : 'https://t.me/saeed1814');
